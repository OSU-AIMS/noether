...
{
/**
 * @brief An implementation of the Raster Planner using a series of parallel cutting planes that have a pre-determined line spacing
 ...
 */
class PlaneVariableSlicerRasterPlanner : public RasterPlanner
{
public:
  PlaneVariableSlicerRasterPlanner(DirectionGenerator::ConstPtr dir_gen, OriginGenerator::ConstPtr origin_gen);
...
struct PlaneVariableSlicerRasterPlannerFactory : public RasterPlannerFactory
{
  bool bidirectional;
  ...
  std::vector<float> line_spacing_varied;
